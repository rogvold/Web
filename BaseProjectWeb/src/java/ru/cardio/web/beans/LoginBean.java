...
//    for registration
    ...
    private boolean checkEmailAndPasword() throws CardioException {
        boolean b = true;
    ...
    private boolean checkLoginData() throws CardioException {
        boolean b = true;
    ...
    private boolean checkRegistrationData() throws CardioException {
        boolean b = true;
        b = checkEmailAndPasword();
