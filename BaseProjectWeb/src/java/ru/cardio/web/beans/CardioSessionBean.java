...
//    public List<CardioSession> 
    ...
    public int amountOfRatesById(Long sessionId) throws CardioException {
        return sm.getSessionRatesAmountById(sessionId);
    }

    public Long durationBySessionId(Long sessionId) throws CardioException {
        return sm.getSessionDurationById(sessionId);
    }

    public String prettyDurationBySessionId(Long sessionId) throws CardioException {
    ...
    public Date startDateBySessionId(Long sessionId) throws CardioException {
