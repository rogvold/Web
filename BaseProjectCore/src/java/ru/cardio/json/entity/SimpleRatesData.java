 ...
 */
public class SimpleRatesData extends JsonEntityAbstract  {
    ...
    public static SimpleRatesData fromJson(String json) throws CardioException {
        try {
            System.out.println("fromJson json = " + json);
            ...
            throw new CardioException("Cannot parse json = " + json + " e = " + e.getMessage(), ResponseConstants.NORMAL_ERROR_CODE);
        }
    }
